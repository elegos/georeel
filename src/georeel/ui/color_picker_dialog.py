...
class _ColorSwatch(QFrame):
    ...
    def _update_border(self) -> None:
        ...
        if self._selected:
            ...
            p.setColor(
                QPalette.ColorRole.Window, app_palette.color(QPalette.ColorRole.Window)
            )
            p.setColor(
                QPalette.ColorRole.WindowText,
                app_palette.color(QPalette.ColorRole.WindowText),
            )
...
class ColorPickerDialog(QDialog):
    ...
    def _update_preview(self) -> None:
        ...
        palette.setColor(
            self._preview_swatch.backgroundRole(), QColor(self._selected_hex)
        )
